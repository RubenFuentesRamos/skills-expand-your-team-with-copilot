  ...
  function renderActivityCard(name, details) {
    ...
    if (details.difficulty) {
      const difficultyColors = {
        Beginner: { bg: "#c8e6c9", color: "#2e7d32" },
        Intermediate: { bg: "#fff9c4", color: "#f57f17" },
        Advanced: { bg: "#ffccbc", color: "#d84315" }
      };
      const difficultyColor = difficultyColors[details.difficulty] || { bg: "#e0e0e0", color: "#424242" };
      difficultyBadgeHtml = `
        <span class="difficulty-badge" style="background-color: ${difficultyColor.bg}; color: ${difficultyColor.color}">
          ${details.difficulty}
        </span>
      `;
    }
